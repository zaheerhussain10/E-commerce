...
import com.wipro.eCommerce.securityfilter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public  SecurityFilterChain   getSecurityFilterChain(HttpSecurity http) throws Exception {
    		...
    		return http.csrf().disable()
    			.authorizeHttpRequests().requestMatchers("/products/welcome","/users/registration/new","/users/login/authenticate")
    			.permitAll()
    			.and()
